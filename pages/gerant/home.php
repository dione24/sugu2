...
<div class="row">
  <div class="col-lg-3 col-xs-6">
    <div class="small-box bg-green">
      ...
      <a href="pages.php?access=gerant&pages=view&display=listes_espaces" class="small-box-footer">Plus <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-3 col-xs-6">
    <div class="small-box bg-yellow">
      ...
      <a href="pages.php?access=gerant&pages=view&display=espaces_louee" class="small-box-footer">Plus <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
    ...
    <div class="small-box bg-green">
     ...
     <a href="pages.php?access=gerant&pages=view&display=listes_non_occupe" class="small-box-footer">Plus <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-3 col-xs-6">
    <div class="small-box bg-red">
      ...
      <div class="icon">
        ...
        <a href="pages.php?access=gerant&pages=view&display=impaye_paiement&id_mois=<?= $mois;?>&annee=<?= $annee;?>" class="small-box-footer">Plus <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
</div>
<div class="row">
