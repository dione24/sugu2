...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="pages.php?access=gerant&pages=home"><i class="fa fa-dashboard"></i> Accueil</a></li>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:justify;"> <a class="btn btn-success"
                                        href="pages.php?access=gerant&pages=ajouter_clients&display=update_clients&id_clients=<?= $AfficherCustomers['id_clients']; ?>"><i
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-success"
                                        href="pages.php?access=gerant&pages=ajouter_clients&display=paiement_location&id_espaces=<?= $AfficherEspacesOccupee['id_espaces']; ?>">Paiement</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
...
<div class="card">
    <div class="col-lg-12">
        <div style="text-align:center;" class="card-body">
            ...
            <a href="pages.php?access=gerant&pages=profile&display=first" class="btn btn-primary"><i class="fa fa-lock">
...
<section class="content">
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                <div class="box-body">
                    <a class="btn btn-primary" href="pages.php?access=gerant&pages=add&display=add_users"><i
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a class="btn btn-primary"
                                        href="pages.php?access=gerant&pages=add&display=update_users&id_users=<?= $AfficherUsers['id_users']; ?>"><i
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:justify; text-color: white;width: auto;"> <a
                                        ...
                                        href="pages.php?access=gerant&pages=ajouter_clients&display=louer_espace&id_espaces=<?= $AfficherEspaces['id_espaces']; ?>">Louer</a>
                                    <a class="btn btn-primary"
                                        href="pages.php?access=gerant&pages=ajouter_clients&display=vente_espace&id_espaces=<?= $AfficherEspaces['id_espaces']; ?>">Vendre</a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
