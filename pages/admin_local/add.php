                                      ...
                                      <div class="box box-primary">
                                        ...
                                        <form method="post" action="config/actions.php?q=update_pin"role="form">
                                          <div class="box-body">
                                            <div class="form-group">
                                              <label for="exampleInputEmail1">Password</label>
                                              <input type="password" name="auth_confirm" class="form-control" id="exampleInputEmail1"  required>
                                            </div>
                                          </div>
                                          <div class="box-footer">
                                            <button type="submit" class="btn btn-primary">Changer</button>
                                              ...
                                              <form method="post" action="config/actions.php?q=add_carnet"role="form">
                                                <div class="box-body">
                                                  <div class="form-group">
                                                    ...
                                                    <input type="int" name="numero_carnet" class="form-control" id="exampleInputEmail1" placeholder="Veuillez entrer le numero du carnet">
                                                  </div>
                                                  <div class="form-group">
