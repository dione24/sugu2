                            ...
                            <tbody>
                                <?php foreach ($GetEspacesOccupee as $key => $AfficherEspacesOccupee) {
                                    ...
                                    <tr>
                                        ...
                                        <td> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#query-<?= $AfficherEspacesOccupee['id_espaces']; ?>"><i class="fa fa-question-circle"></i>
                                            </button>
                                        </td>
                                    </tr>
                            ...
                            <tbody>
                                <?php foreach ($GetEspacesOccupee as $key => $AfficherEspacesOccupee) { ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-success" href="pages.php?access=visiteur&pages=ajouter_clients&display=paiement_location&id_espaces=<?= $AfficherEspacesOccupee['id_espaces']; ?>">Paiement</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
    ...
    <div class="card">
        <div class="col-lg-12">
            <div style="text-align:center;" class="card-body">
                ...
                <a href="pages.php?access=visiteur&pages=profile&display=first" class="btn btn-primary"><i class="fa fa-lock"> Change my Password</i></a>
            </div>
        </div>
    </div>
<?php } ?>
