...
<div class="row">
  <div class="col-lg-4 col-xs-6">
    <div class="small-box bg-green">
      ...
      <a href="pages.php?access=visiteur&pages=view&display=listes_espaces" class="small-box-footer">Plus <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
  <div class="col-lg-4 col-xs-6">
    <div class="small-box bg-yellow">
      ...
      <a href="pages.php?access=visiteur&pages=view&display=espaces_louee" class="small-box-footer">Plus <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
      <div class="col-lg-4 col-xs-6">
    <!-- small box -->
    <div class="small-box bg-green">
     ...
     <a href="pages.php?access=visiteur&pages=view&display=listes_non_occupe" class="small-box-footer">Plus <i class="fa fa-arrow-circle-right"></i></a>
    </div>
  </div>
