                        ...
                        <form method="post" action="">
                            <div class="col-md-1">
                                <div class="form-group">
                                    <input type="int" name="year" value="<?= (isset($_POST['year'])) ? $_POST['year'] : ''; ?>" class="form-control" placeholder="Year">
                                </div>
                            </div>
                            ...
                            <tbody>
                                <?php foreach ($GetEspacesOccupee as $key => $AfficherEspacesOccupee) {
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-danger" onclick="return confirm('Etes vous sur de vous ?')" href="config/actions.php?q=resilier_espaces&id_espaces=<?= $AfficherEspacesOccupee['id_espaces']; ?>&id_clients=<?= $AfficherEspacesOccupee['id_clients']; ?>">Résilier</a>
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#query-<?= $AfficherEspacesOccupee['id_espaces']; ?>"><i class="fa fa-question-circle"></i>
                                            </button>
                                        </td>
                                    </tr>
                                    <div class="modal fade" id="query-<?= $AfficherEspacesOccupee['id_espaces']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <?php foreach ($ImpayeLocation as $key => $data) { ?>
                                                        <p> <input type="checkbox" <?php if ($data['DATA'] != NULL) { ?> checked="" <?php } ?> /> <?= $data['nom_mois'] . ' - ' . $data['DATA']; ?></p>
                                                    <?php } ?>
                                                    <hr>
                            ...
                            <tbody>
                                <?php foreach ($GetCustomers as $key => $AfficherCustomers) { ?>
                                    <tr>
                                        ...
                                        <td style="text-align:justify;"> <a class="btn btn-success" href="pages.php?access=admin&pages=ajouter_clients&display=update_clients&id_clients=<?= $AfficherCustomers['id_clients']; ?>"><i class="fa fa-edit"> Modifier</i></a>
                                            <a class="btn btn-danger" href="config/actions.php?q=delete_clients&id_clients=<?= $AfficherCustomers['id_clients']; ?>" onclick="return confirm('Etes vous sur de continuer cette action car elle est irreversible?')">
                            ...
                            <tbody>
                                <?php foreach ($GetResilier as $key => $AfficherResilier) { ?>
                                    <tr>
                                        ...
                                        <td style="text-align:justify;"><a class="btn btn-danger" href="config/actions.php?q=delete_resilier&id_resiliation=<?= $AfficherResilier['id_resiliation']; ?>" onclick="return confirm('Etes vous sur de continuer cette action car elle est irreversible?')">
                                                <i class="fa fa-times"> Supprimer</i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td style="text-align:justify; text-color: white;width: auto;">
                                            <?php if (empty($AfficherEspaces['nom'])) { ?> <a class="btn btn-success" href="pages.php?access=admin&pages=ajouter_clients&display=louer_espace&id_espaces=<?= $AfficherEspaces['id_espaces']; ?>">Louer</a><?php } else { ?>
                                                <a class="btn btn-danger" onclick="return confirm('Etes vous sur de vous ?')" href="config/actions.php?q=resilier_espaces&id_espaces=<?= $AfficherEspaces['id_espaces']; ?>&id_clients=<?= $AfficherEspaces['id_clients']; ?>">Résilier</a>
                                            <?php } ?>
                                            <a href=""><?php if (empty($AfficherEspaces['nom'])) { ?> <a class="btn btn-primary" href="pages.php?access=admin&pages=ajouter_clients&display=vente_espace&id_espaces=<?= $AfficherEspaces['id_espaces']; ?>">Vendre</a><?php } ?></a>
                                        </td>
                                        <td> <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#query-<?= $AfficherEspaces['id_espaces']; ?>"><i class="fa fa-eye"></i>
                                            </button></td>
                                        <td style=" text-align:justify;"> <a class="btn btn-success" href="pages.php?access=admin&pages=ajouter_clients&display=update_epaces&id_espaces=<?= $AfficherEspaces['id_espaces']; ?>"><i class="fa fa-edit"> Modifier</i></a>
                                            <a class="btn btn-danger" href="config/actions.php?q=delete_espaces&id_espaces=<?= $AfficherEspaces['id_espaces']; ?>" onclick="return confirm('Etes vous sur de continuer cette action car elle est irreversible?')">
                                                <i class="fa fa-times"> Supprimer</i></a>
                                        </td>
                                    </tr>
                                    <div class="modal fade" id="query-<?= $AfficherEspaces['id_espaces']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                            ...
                            <tbody>
                                <?php foreach ($GetPaiements as $key => $AfficherOperations) { ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-danger" href="config/actions.php?q=delete_paiement&id_payements=<?= $AfficherOperations['id_payements']; ?>" onclick="return confirm('Etes vous sur de continuer cette action car elle est irreversible?')">
...
<?php if ($_GET['display'] == 'attente_confirm') {
                ...
                <div class="box">
                    <div class="box-body">
                        <?php if (empty($_SESSION['chmod'])) { ?>
                            <button class="btn btn-success" data-toggle="modal" data-target="#verifySession">S'Authentifier</button>
                        <?php } ?>
                            ...
                            <tbody>
                                <?php foreach ($GetConfirmList as $key => $AfficherOperations) { ?>
                                    <tr>
                                        ...
                                        <td><?= $AfficherOperations['montant_recu']; ?></td>
                                        <td><?= date('Y-m-d', strtotime($AfficherOperations['date_recu'])); ?></td>
                                        <?php if (!empty($_SESSION['chmod'])) { ?> <td> <a class="btn btn-success" href="config/actions.php?q=confirm_paiement&id_payements=<?= $AfficherOperations['id_payements']; ?>"><i class="fa fa-check-square"> Confirmer</i></a>
                                                <a class="btn btn-danger" href="pages.php?access=admin&pages=ajouter_clients&display=reset_message&id_payements=<?= $AfficherOperations['id_payements']; ?>&id_espaces=<?= $AfficherOperations['id_clients_espaces']; ?> "><i class="fa fa-times"> Rejeter</i></a>
                                            </td>
                                        <?php } ?>
                                    </tr>
                                <?php } ?>
    ...
    <form method="POST" action="config/actions.php?q=auth_confirm">
        <div class="modal fade" id="verifySession" tabindex="-1" role="dialog" aria-labelledby="verifySession" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <input type="hidden" id="defaultForm-pass" name="url_page" value="<?= $_SERVER['REQUEST_URI']; ?>" class="form-control validate" required>
                        <div class="modal-body">
                            <label data-error="wrong" data-success="right" for="defaultForm-pass">PassCode</label>
                            <input type="password" id="defaultForm-pass" name="auth_confirm" class="form-control validate" required>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
                            ...
                            <tbody>
                                <?php foreach ($GetEspacesOccupee as $key => $AfficherEspacesOccupee) { ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-success" href="pages.php?access=admin&pages=ajouter_clients&display=paiement_location&id_espaces=<?= $AfficherEspacesOccupee['id_espaces']; ?>">Paiement</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        ...
                        <form method="post" action="">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label>Mois</label>
                                    <select class="form-control select2" name="id_mois" data-placeholder="Choisir un mois" style=" text-align: center; width: 100%;">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Année</label>
                                    <select class="form-control select2" name="annee" data-placeholder="Choisir un mois" style=" text-align: center; width: 100%;">
                                        <option>Choisir..</option>
                                        <option>2016</option>
                                        <option>2017</option>
                                        <option>2018</option>
    ...
    <div class="card">
        <div class="col-lg-12">
            <div style="text-align:center;" class="card-body">
                ...
                <a href="pages.php?access=admin&pages=profile&display=passcode" class="btn btn-primary"><i class="fa fa-lock">PassCode</i></a>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        <a class="btn btn-primary" href="pages.php?access=admin&pages=add&display=add_users"><i class="fa fa-plus"> Ajouter</i></a></br></br>
                        <table id="dataTable" class="table table-striped table-bordered table-hover dataTables-example">
                            <thead>
                                <tr>
                                    <th>Nom</th>
                            ...
                            <tbody>
                                <?php foreach ($GetUsers as $key => $AfficherUsers) { ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-primary" href="pages.php?access=admin&pages=add&display=update_users&id_users=<?= $AfficherUsers['id_users']; ?>"><i class="fa fa-pencil"> Modifier</i></a>
                                            <a class="btn btn-danger" href="config/actions.php?q=delete_users&id_users=<?= $AfficherUsers['id_users']; ?>" onclick="return confirm('Etes vous sur de continuer cette action car elle est irreversible?')"><i class="fa fa-times"> Supprimer</i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                                ...
                                <tbody>
                                    <?php foreach ($GetMessages as $key => $AfficherMessages) { ?>
                                        <tr>
                                            ...
                                            <td class="mailbox-name"><a href="#"><?= $AfficherMessages['bloc'] . '-' . $AfficherMessages['numero']; ?></a>
                                            </td>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        <a class="btn btn-primary" href="pages.php?access=admin&pages=add&display=add_carnet"><i class="fa fa-plus"> Ajouter</i></a></br></br>
                        <table id="dataTable" class="table table-striped table-bordered table-hover dataTables-example">
                            <thead>
                                <tr>
                                    <th>Numero CARNET</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $NbreCarnet; ?></td>
                                        <td><?= $Restant; ?></td>
                                        <td><button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalStatut-<?= $AfficherResultat['NumCarnet']; ?>">
                                                <i class="fa fa-eye"> </i>
                                            </button></td>
                                    </tr>
                            ...
                            <tbody>
                                <?php foreach ($GetEspaces as $key => $AfficherEspaces) { ?>
                                    <tr>
                                        ...
                                        <td><?= $AfficherEspaces['position']; ?></td>
                                        <td><?= $AfficherEspaces['superficie']; ?></td>
                                        <td style="text-align:justify; text-color: white;width: auto;"> <a class="btn btn-success" href="pages.php?access=admin&pages=ajouter_clients&display=louer_espace&id_espaces=<?= $AfficherEspaces['id_espaces']; ?>">Louer</a>
                                            <a class="btn btn-primary" href="pages.php?access=admin&pages=ajouter_clients&display=vente_espace&id_espaces=<?= $AfficherEspaces['id_espaces']; ?>">Vendre</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
