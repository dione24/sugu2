                    ...
                    <form method="post" action="config/actions.php?q=add_espaces" role="form">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input name="numero" type="text" class="form-control" id="exampleInputEmail1" placeholder="Veuillez saisir le numero  de l'espace">
                            </div>
                            <div class="form-group">
...
<?php if ($_GET['display'] == 'louer_espace') {
    ...
    $GetTypeEsapces = GetTypeEsapces($baseDeDonnee);
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <label>Client</label>
                                <select class="form-control select2" name="id_clients" data-placeholder="Choisir un  client" style=" text-align: center; width: 100%;">
                                    <option>Choisir un client</option>
                                    <?php foreach ($GetCustomers as $key => $afficherClient) { ?>
                                        <option value="<?= $afficherClient['id_clients']; ?>">
                                            <?= $afficherClient['nom'] . " " . $afficherClient['prenom'] . " " . $afficherClient['telephone']; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control " name="RefType">
                                    <?php foreach ($GetTypeEsapces as $key => $afficher) { ?>
                                        <option value="<?= $afficher['RefType']; ?>">
                                            <?= $afficher['name_type']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
...
<?php if ($_GET['display'] == 'vente_espace') {
    ...
    <section class="content">
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">Location</h3>
                <div class="box-tools pull-right"> type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button> type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
                </div>
            </div>
            <for m method="post" action="config/actions.php?q=vente_espace">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group"> ut class="form-control col-md-1" name="id_espaces" type="hidden"
                                value="<?= $GetEspaces['id_espaces']; ?>">
                                <label>Client</label> ect class="form-control select2" name="id_clients"
                                data-placeholder="Choisir un client"
                                style=" text-align: center; width: 100%;">
                                <option>Choisir un client</option>
                                <?php foreach ($GetCustomers as $key => $afficherClient) { ?>
                                    <opt ion value="<?= $afficherClient['id_clients']; ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Bloc et Numero</label> ut type="text"
                                value="<?= $GetEspaces['bloc'] . '-' . $GetEspaces['numero']; ?>"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Payé chez</label> ect class="form-control " name="from_paiement"
                                data-placeholder="Choisir un client"
                                style=" text-align: center; width: 100%;">
                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header">
                            ...
                            <div class="pull-right box-tools"> ton type="button" class="btn btn-info btn-sm"
                                data-widget="collapse" data-toggle="tooltip"
                                title="Collapse">
                                <i class="fa fa-minus"></i></button> ton type="button" class="btn btn-info btn-sm"
                                data-widget="remove" data-toggle="tooltip"
                                title="Remove">
                                <i class="fa fa-times"></i></button>
                            </div>
                        </div>
                        <for m method="post" action="config/actions.php?q=reset_operation">
            ...
            <sec tion class="content-header">
                ...
                <section class="content">
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h3 class="box-title">Location</h3>
                            <div class="box-tools pull-right"> type="button" class="btn btn-box-tool"
                                data-widget="collapse"><i class="fa fa-minus"></i></button> type="button" class="btn
                                btn-box-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
                            </div>
                        </div>
                        <form method="post" action="config/actions.php?q=paiement_location">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">put class="form-control col-md-1" name="id_espaces"
                                            type="hidden"
                                            value="<?= $GetEspaces['id_espaces']; ?>">
                                            <label>Mois</label>lect class="form-control select2" name="id_mois"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Annee</label>lect class="form-control select2" name="annee"
                                            data-placeholder="Choisir un mois"
                                            style=" text-align: center; width: 100%;">
                                            <option>Choisir..</option>
                                            <?php foreach ($GetYear as $key => $Afficher) { ?>
                                                <option value="<?= $Afficher['year']; ?>">
                                                    <?= $Afficher['year']; ?>
                                                </option>
                                            <?php } ?>
                                            </select>
                        ...
                        <div style="  margin-left: 200px; margin-right: auto;" class="col-md-6">
                            <div class="box box-primary">
                                ...
                                <form method="post" action="config/actions.php?q=check_password" role="form">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Password</label>put type="password"
                    ...
                    <div class="row">
                        <div style="  margin-left: 200px; margin-right: auto;" class="col-md-6">
                            <div class="box box-primary">
                                ...
                                <for m method="post" action="config/actions.php?q=update_password" role="form">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Password</label>nut type="password"
                                            name="password" class="form-control" id="exampleInputEmail1"
                                            required>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div style="" class="col-md-10">
                            <div class="box box-primary">
                                ...
                                <for m method="post" action="config/actions.php?q=add_users" role="form">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nom</label>
                                        ...
                                        <div class="form-group">
                                            <label>Status</label> ect class="form-control select2" name="status"
                                            data-placeholder="Choisir un client"
                                            style=" text-align: center; width: 100%;">
                                            <option>Choisir..</option>
                    ...
                    <div class="row">
                        <div style="" class="col-md-10">
                            <div class="box box-primary">
                                ...
                                <for m method="post" action="config/actions.php?q=update_users" role="form">
                                    <div class="box-body">
                                        <div class="form-group"> ut type="hidden" name="id_users"
                                            value="<?= $GetUsers['id_users']; ?>"
                                            class="form-control" id="exampleInputPassword1">
                                            <label for="exampleInputEmail1">Nom</label> ut type="text" name="nom"
                                            value="<?= $GetUsers['nom']; ?>" class="form-control"
                                            id="exampleInputEmail1">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Prenom</label>put type="text" name="prenom"
                                            value="<?= $GetUsers['prenom']; ?>" class="form-control"
                                            id="exampleInputPassword1">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Login</label> ut type="text" name="login"
                                            value="<?= $GetUsers['login']; ?>" class="form-control"
                                            id="exampleInputPassword1">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Password</label>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Passcode</label> ut type="password"
                                            name="auth_confirm" value="<?= $GetUsers['auth_confirm']; ?>"
                                            class="form-control" id="exampleInputPassword1">
                                        </div>
                                    </div>
                                    <div class="box-footer">
                    ...
                    <div class="row">
                        <div style="  margin-left: 200px; margin-right: auto;" class="col-md-6">
                            <div class="box box-primary">
                                ...
                                <for m method="post" action="config/actions.php?q=update_pin" role="form">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Password</label> ut type="password"
                                            name="auth_confirm" class="form-control" id="exampleInputEmail1"
                                            required>
                                        </div>
                                    </div>
                                    <div class="box-footer">
                    ...
                    <div class="row">
                        <div style="" class="col-md-12">
                            <div class="box box-primary">
                                ...
                                <for m method="post" action="config/actions.php?q=add_carnet" role="form">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Numero Carnet</label> ut type="int"
                                            name="numero_carnet" class="form-control" id="exampleInputEmail1"
