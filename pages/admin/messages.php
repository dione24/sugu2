...
<li class="dropdown messages-menu">
  ...
  <ul class="dropdown-menu">
    ...
    <li>
      <ul class="menu">
        <?php foreach ($GetMessages as $key => $AfficherMessages) { ?>
          <li>
            <a href="pages.php?access=admin&pages=view&display=inbox">
              <div class="pull-left">
              ...
              <h4>
                ...
                <small><i class="fa fa-clock-o"></i>
                  <?= date('Y-m-d', strtotime($AfficherMessages['date_notification'])); ?></small>
              </h4>
    ...
    <li class="footer"><a href="pages.php?access=admin&pages=view&display=inbox">Voir Plus</a></li>
  </ul>
</li>