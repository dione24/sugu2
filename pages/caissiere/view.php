                            ...
                            <tbody>
                                <?php foreach ($GetEspacesOccupee as $key => $AfficherEspacesOccupee) { ?>
                                    <tr>
                                        ...
                                        <td><a class="btn btn-success" href="pages.php?access=caissiere&pages=ajouter_clients&display=paiement_location&id_espaces=<?= $AfficherEspacesOccupee['id_espaces']; ?>">Paiement</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
    ...
    <div class="card">
        <div class="col-lg-12">
            <div style="text-align:center;" class="card-body">
                ...
                <a href="pages.php?access=caissiere&pages=profile&display=first" class="btn btn-primary"><i class="fa fa-lock"> Change my Password</i></a>
            </div>
        </div>
    </div>
<?php } ?>
